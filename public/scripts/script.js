...
let confetti = new Confetti('spinner');
confetti.setCount(575);
confetti.setSize(1);
confetti.setPower(125);
...
function validatePass() {
  ...
  if (pass.length > 0 && confirmPass.length > 0 && pass != confirmPass) {
    ...
    submitBtn.classList.add("brightness-50");
    ...
    submitBtn.classList.remove("brightness-50");
